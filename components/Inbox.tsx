...
export const Inbox: React.FC<InboxProps> = ({ setView }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto flex flex-col pt-4 px-4 pb-10">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-serif font-bold text-[var(--text-primary)]">Inbox</h2>
        <button 
          onClick={() => setComposeOpen(true)}
          className="bg-[var(--button-green)] text-white px-4 py-2 rounded font-bold text-sm shadow hover:opacity-90 flex items-center gap-2"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 min-h-0">
        ...
        {/* Message List */}
        <div className="sketch-card md:col-span-4 lg:col-span-4 bg-[var(--bg-color)] overflow-y-auto max-h-[40vh] md:max-h-[70vh]">
          {messages.length === 0 && (
        ...
        {/* Message Detail */}
        <div className="sketch-card md:col-span-8 lg:col-span-8 bg-[var(--surface-color)] flex flex-col min-h-[400px]">
           {selectedMessage ? (
